...
const BeeswarmChartComponent = ({
  initialData = null,
  chartColor = "#d29922",
}) => {
  const [data, setData] = useState(DEFAULT_DATA);
  const [titleText, setTitleText] = useState("Beeswarm Chart");
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={controlsGridStyle}>
        ...
        <div style={controlGroupStyle}>
          <label style={labelStyle}>↔️ Spacing: {spacing.toFixed(2)}</label>
          <input
            type="range"
            min="0.05"
            max="0.3"
...
export default BeeswarmChartComponent;
