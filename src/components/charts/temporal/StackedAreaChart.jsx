...
const DEFAULT_DATA = [
  { name: "Q1", series1: 30, series2: 40, series3: 20 },
  { name: "Q2", series1: 45, series2: 35, series3: 25 },
  { name: "Q3", series1: 50, series2: 30, series3: 30 },
  { name: "Q4", series1: 40, series2: 50, series3: 35 },
];
...
const StackedAreaChartComponent = ({
  ...
  const [titleText, setTitleText] = useState("Stacked Area Chart");
