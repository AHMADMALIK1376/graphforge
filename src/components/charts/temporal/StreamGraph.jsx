...
const DEFAULT_DATA = [
  { name: "Jan", series1: 30, series2: 40, series3: 20 },
  { name: "Feb", series1: 45, series2: 35, series3: 25 },
  { name: "Mar", series1: 50, series2: 30, series3: 30 },
  { name: "Apr", series1: 35, series2: 45, series3: 35 },
  { name: "May", series1: 55, series2: 25, series3: 40 },
  { name: "Jun", series1: 40, series2: 50, series3: 30 },
  { name: "Jul", series1: 60, series2: 30, series3: 45 },
  { name: "Aug", series1: 45, series2: 40, series3: 35 },
];
...
const StreamGraphComponent = ({
  ...
  const [titleText, setTitleText] = useState("Stream Graph");
  ...
  const addRow = useCallback(() => {
    const row = { name: `Point ${data.length + 1}` };
    seriesKeys.forEach((k) => (row[k] = Math.floor(Math.random() * 40) + 20));
