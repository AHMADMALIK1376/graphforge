...
const LineChartComponent = ({
  ...
  const [titleText, setTitleText] = useState("Line Chart");
  const [lineColor, setLineColor] = useState(chartColor);
  const [fillColor, setFillColor] = useState(chartColor);
    ...
    if (active && payload && payload.length) {
      return (
        ...
        >
          ...
          <p style={{ margin: 0, color: lineColor }}>
  ...
  return (
    <div style={containerStyle}>
      ...
      <div id="chart-visual-area" style={chartContainerStyle}>
        <ResponsiveContainer width="100%" height={420}>
          ...
          >
            ...
            <Legend />
            <Line
              type={smoothness > 0.3 ? "monotone" : "linear"}
              dataKey="value"
              stroke={lineColor}
      ...
      <div style={controlsGridStyle}>
        ...
        <div style={controlGroupStyle}>
          <label style={labelStyle}>🏔️ Area Fill</label>
