...
const PieChartComponent = ({
  ...
  const [titleText, setTitleText] = useState("Pie Chart");
      ...
      return (
        ...
        >
          ...
          <p style={{ margin: 0, color: "#8b949e" }}>
            {((d.payload.value / total) * 100).toFixed(1)}%
          </p>
        </div>
      );
    }
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={controlsGridStyle}>
        ...
        <div style={controlGroupStyle}>
          ...
          <label style={checkboxStyle}>
            ...
            />
            <span style={{ fontSize: "11px", color: "#c9d1d9" }}>Display</span>
          </label>
        </div>
        <div style={controlGroupStyle}>
      ...
      >
        ...
        <span style={{ color: "#8b949e" }}>
          Slices: <strong style={{ color: chartColor }}>{data.length}</strong>
        </span>
      </div>
              ...
              {data.map((row, i) => (
                <tr key={i}>
                  ...
                  >
                    <input
                      type="color"
                      value={row.color || COLORS[i % COLORS.length]}
                      onChange={(e) =>
                        handleDataChange(i, "color", e.target.value)
                      }
                      style={{
                        width: "24px",
                        height: "20px",
